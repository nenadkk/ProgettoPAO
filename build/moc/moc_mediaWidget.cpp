...
#include <memory>
#include "../../src/grafica/mediaWidget.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_mediaWidget_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_mediaWidget_t qt_meta_stringdata_mediaWidget = {
    {
        QT_MOC_LITERAL(0, 11),  // "mediaWidget"
        QT_MOC_LITERAL(12, 7),  // "clicked"
        QT_MOC_LITERAL(20, 0),  // ""
        QT_MOC_LITERAL(21, 15),  // "modificaClicked"
        QT_MOC_LITERAL(37, 14)   // "eliminaClicked"
    },
    "mediaWidget",
    "clicked",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_mediaWidget[] = {
...
Q_CONSTINIT const QMetaObject mediaWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_mediaWidget.offsetsAndSizes,
...
void mediaWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->modificaClicked(); break;
        case 2: _t->eliminaClicked(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &mediaWidget::clicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
